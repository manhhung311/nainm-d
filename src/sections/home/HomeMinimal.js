...
function HomeMinimal(props) {
    const [data, setData] = useState([
        ...
        },
        {
            ...
            content: 'Nitrogen and Sulfur Rich Covalent Organic Framework-Chitosan Triboelectric Nanogenerator for Disposable Urination Evaluation Tool',
        ...
        },
        {
            ...
            content: ' Polysulfonated Covalent Organic Framework as Active Electrode Host for Mobile Cation Guests in Electrochemical Soft Actuator',
            ...
            <Box sx={{ height: '100%', py: 10 }}>
                <Grid container spacing={2} alignItems="center" justifyContent="center">
                    ...
                    <Grid item xs={11} md={8.86} sx={{ height: '63px' }}>
                        ...
                        <Grid container spacing={2} alignItems="center" justifyContent="center" flexDirection={{ xs: 'column-reverse', md: 'row' }}>
                            <Grid item xs={12} md={7} sx={{ backgroundColor: '#F6F6F7', padding: 5 }}>
                                ...
                                <Box sx={{ display: 'flex' }}>
                                    <Link sx={{ color: '#3549c1', fontSize: '90px' }} to='/'>{displayedData.link}</Link>
                                ...
                                <Grid container spacing={2} alignItems="center" justifyContent="center" sx={{ paddingTop: '20px' }}>
                                    ...
                                    <Grid item xs={6} md={4.5}>
                                        <img src={displayedData.imgPath} alt="Publication" style={{
                                            maxHeight: '243px', width: '100%', objectFit: 'cover'
                                        }} />
                                    </Grid>
                                    <Grid item xs={3} md={3.75} />
                                    </Grid>
                            ...
                            <Grid xs={12} md={5} sx={{ padding: '2px', backgroundColor: '#ffff', cursor: 'pointer' }}>
                                <Grid container spacing={0} sx={{ flexDirection: { xs: 'row', sm: 'row', md: 'column' } }}>
                                    {data.map((item, index) => (
                                        <Grid item xs={4} md={12} key={index} sx={{
